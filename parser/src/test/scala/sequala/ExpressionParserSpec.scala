...
class ExpressionParserSpec extends Specification {
  ...
  "The Expression Parser" should {
    ...
    "Parse Variables" >> {
      Parse("A") should beEqualTo(Column(sequala.common.Name("A")))
      Parse("R.A") should beEqualTo(Column(sequala.common.Name("A"), Some(sequala.common.Name("R"))))
      Parse("`A`") should beEqualTo(Column(sequala.common.Name("A", true)))
      Parse("`R`.A") should beEqualTo(Column(sequala.common.Name("A"), Some(sequala.common.Name("R", true))))
      Parse("Foo.`Bar`") should beEqualTo(Column(sequala.common.Name("Bar", true), Some(sequala.common.Name("Foo"))))
      Parse("int") should beEqualTo(Column(sequala.common.Name("int")))
      Parse("_c0") should beEqualTo(Column(sequala.common.Name("_c0")))
    }
    ...
    "Parse CASE Expressions" >> {
      Parse("CASE WHEN A > 1 THEN B ELSE C END") should beEqualTo(
        CaseWhenElse(
          None,
          Seq(Comparison(Column(sequala.common.Name("A")), Comparison.Gt, LongPrimitive(1)) -> Column(Name("B"))),
          Column(Name("C"))
        )
      )
      ...
      Parse("IF A = 1 THEN B ELSE C END") should beEqualTo(
        CaseWhenElse(
          None,
          Seq(Comparison(Column(sequala.common.Name("A")), Comparison.Eq, LongPrimitive(1)) -> Column(Name("B"))),
          Column(Name("C"))
        )
      )
    }
    ...
    "Parse BETWEEN Expressions" >> {
      Parse("A BETWEEN 1 AND 2") should beEqualTo(
        Arithmetic(
          Comparison(Column(sequala.common.Name("A")), Comparison.Gte, LongPrimitive(1)),
          Arithmetic.And,
          Comparison(Column(sequala.common.Name("A")), Comparison.Lte, LongPrimitive(2))
        )
      )
      Parse("A+2 BETWEEN 1 AND 2") should beEqualTo(
        Arithmetic(
          Comparison(
            Arithmetic(Column(sequala.common.Name("A")), Arithmetic.Add, LongPrimitive(2)),
            Comparison.Gte,
            LongPrimitive(1)
          ),
          Arithmetic.And,
