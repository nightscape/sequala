...
import sequala.common.{AnsiDialect, Dialect, Dialects, OracleDialect, PostgresDialect, given}
...
object Subcommands:
  ...
  def sync(
    ...
    SyncRunner.runSync(desired, db, key, format, pretty, writeTo, sourceTransform, transform, withDeletes, tableFilter)
