...
-- =====================================================
-- DATA COMPARISON (using DBMS_COMPARISON for tables that exist in both)
-- =====================================================
PROMPT
...
-- Show row differences for all comparisons
PROMPT
PROMPT === Row Differences (all tables) ===
...
WHERE r.comparison_name LIKE 'CMP_&schema_pattern%'
