...
lazy val migratePostgres =
  ...
  .dependsOn(migrate, schemaPostgres, migrate % "test->test")
  .settings(
...
lazy val migrateOracle =
  ...
  .dependsOn(migrate, schemaOracle, migrate % "test->test")
  .settings(
